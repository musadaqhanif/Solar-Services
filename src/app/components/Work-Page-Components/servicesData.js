import { FaLeaf, FaSun, FaTools, FaChartLine } from "react-icons/fa";
...
export const services = [
  {
    ...
    description:
      "Expert installation of high-efficiency solar panels for residential properties, tailored to maximize energy production.",
    highlight: [
  ...
  },
  {
    ...
    description:
      "Professional installation of solar systems for businesses, designed to reduce energy costs and carbon footprint.",
    highlight: [
  ...
  },
  {
    ...
    description:
      "Comprehensive consultation and custom design services to optimize your solar system for energy needs and budget.",
    highlight: [
  ...
  },
  {
    ...
    description:
      "Personalized consultation to enhance energy efficiency, integrating solar with your home’s existing systems.",
    highlight: [
  ...
  },
  {
    ...
    description:
      "Regular maintenance to ensure your solar panels operate at peak efficiency and longevity.",
    highlight: [
  ...
  },
  {
    ...
    description:
      "Continuous monitoring of your solar system to optimize performance and provide real-time data.",
    highlight: [
