  ...
  return (
    <section className="py-16 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl font-bold text-gray-800 mb-8 text-center md:text-left">About Us</h2>
        <div className="flex flex-col md:flex-row items-start gap-8">
          <div className="md:w-1/2">
            ...
            <ul className="space-y-4">
              <li className="flex items-center bg-white p-4 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 group">
                ...
                <span className="text-gray-700 opacity-100 group-hover:opacity-100 transition-opacity duration-500">Over 1000+ happy customers</span>
              </li>
              <li className="flex items-center bg-white p-4 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 group">
                <span className="text-green-600 mr-4 w-4 h-4 rounded-full bg-green-600 flex items-center justify-center text-white font-bold text-lg group-hover:scale-110 transition-transform duration-300">•</span>
                <span className="text-gray-700 opacity-100 group-hover:opacity-100 transition-opacity duration-500">30% energy savings guaranteed</span>
              </li>
              <li className="flex items-center bg-white p-4 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 group">
                <span className="text-green-600 mr-4 w-4 h-4 rounded-full bg-green-600 flex items-center justify-center text-white font-bold text-lg group-hover:scale-110 transition-transform duration-300">•</span>
                <span className="text-gray-700 opacity-100 group-hover:opacity-100 transition-opacity duration-500">Committed to a cleaner, greener future</span>
              </li>
              <li className="flex items-center bg-white p-4 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 group">
                <span className="text-green-600 mr-4 w-4 h-4 rounded-full bg-green-600 flex items-center justify-center text-white font-bold text-lg group-hover:scale-110 transition-transform duration-300">•</span>
                <span className="text-black opacity-100 group-hover:opacity-100 transition-opacity duration-500">Professional certified installers</span>
              </li>
            </ul>
            <button className="mt-6 bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 hover:scale-105 transition-all duration-300 flex items-center">
          ...
          <div className="md:w-1/2">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <Image
                src="/home-about.png" // Replace with your image path
