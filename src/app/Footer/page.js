...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-green-500 to-green-500 text-white pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <a href="/services/residential" className="hover:text-yellow-300">
                Residential Installation
              </a>
            </li>
            <li>
              <a href="/services/commercial" className="hover:text-yellow-300">
                Commercial Installation
              </a>
            </li>
            <li>
              <a href="/services/maintenance" className="hover:text-yellow-300">
                Maintenance & Repairs
              </a>
            </li>
          </ul>
      ...
      <div className="border-t border-white/20 mt-8 pt-4 text-center text-sm text-white/80">
        Developed by <span className="text-yellow-400">Neurix-solution</span> |
        All rights reserved by{" "}
        <span className="text-yellow-400">Neurixsolution</span>
      </div>
    </footer>
  );
}
